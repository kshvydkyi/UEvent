...
event_itemRouter.get('/:id', tryCatch(event_itemController.selectById.bind(event_itemController)));
event_itemRouter.post('/', tryCatch(event_itemController.create.bind(event_itemController)));
event_itemRouter.delete('/:id', tryCatch(event_itemController.deleteById.bind(event_itemController)));
